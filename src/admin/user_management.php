        ...
        <div class="main p-3">
            <div class="container-fluid">
                <div class="mb-2 d-flex justify-content-between align-items-center">
                    <span class="text-secondary">Dashboard > <span class="font-weight-bold text-primary">User Management</span></span>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                ...
                <form id="submitForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-3">
                        <input type="text" id="contact_number" name="contact_number" class="form-control" placeholder="Contact #">
                    </div>
                    <select class="form-control mt-3" id="role" name="role">
