        ...
        <div class="main p-3">
            <div class="container-fluid">
                <div class="mb-2 d-flex justify-content-between align-items-center">
                    <span class="text-secondary">Dashboard > <span class="font-weight-bold text-primary">Maintenance</span></span>
                </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <table id="mytable" class="table table-striped" style="width: 100%;">
                                <thead>
                                    ...
                                    <th class="text-center">Type of Maintenance</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">Landscaping</td>
                                        <td class="text-center">120 P Burog St. Poblacion Mabalacat</td>
