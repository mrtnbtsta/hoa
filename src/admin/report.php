        ...
        <div class="main p-3">
            <div class="container-fluid">
                <div class="mb-2 d-flex justify-content-between align-items-center">
                    <span class="text-secondary">Dashboard > <span class="font-weight-bold text-primary">Report</span></span>
                </div>
                            ...
                            <table id="mytable" class="table table-striped" style="width: 100%;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">Fire Description...</td>
                                        <td class="text-center"><img src="./profile.jpg" class="img-fluid" style="width: 90px; height: 85px;"></td>
                                        <td class="text-center">
                                            ...
                                            <a href=""><i class="fa-solid fa-location-dot text-success" style="font-size: 20px;"></i></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">Joshua Bautista</td>
